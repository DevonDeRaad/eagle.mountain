...
bowtie.ref=/u/home/d/dderaad/project-aguillon/eagle.mountain.scrubjays/CASJ
...
bowtie2 --threads ${threads} -x /u/home/d/dderaad/project-aguillon/eagle.mountain.scrubjays/CASJ \
